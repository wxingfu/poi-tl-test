package com.weixf.plugin.highlight.example;
        ...
        if (null != swagger.getDefinitions()) {
            ...
            swagger.getDefinitions().forEach((name, model) -> {
                ...
                if (null != model.getProperties()) {
                    List<com.weixf.plugin.highlight.example.Property> properties = new ArrayList<>();
                    model.getProperties().forEach((key, prop) -> {
                        com.weixf.plugin.highlight.example.Property property = new com.weixf.plugin.highlight.example.Property();
