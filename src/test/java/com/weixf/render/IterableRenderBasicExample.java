...
public class IterableRenderBasicExample {
    ...
    public void testRenderIterable() throws Exception {
        ...
        data.put("what", "Java Word模板引擎： Minimal Microsoft word(docx) templating with {{template}} in Java. It works by expanding tags in a template using values provided in a JavaMap or JavaObject.");
        ...
        data.put("portrait", Pictures.ofLocal(base + "sayi.png").size(60, 60).create());
        ...
        XWPFTemplate template = XWPFTemplate.compile(templatePath + "iterable_basic.docx");
        template.render(new HashMap<String, Object>() {
            {
                put("mores", mores);
            }
        }).writeToFile(outPath + "out_iterable_basic.docx");
    }
